...
TEST_CASE("Test Evaluator")
{
	...
	SECTION("Test Three of a Kind")
	{
		...
		vector<Card> threes = { a,b,c,d,e,f,g };
		PokerEvaluator evaluateThis(threes);
	...
	SECTION("Test Pair")
	{
		...
		vector<Card> pair = { a,b,c,d,e,f,g };
		PokerEvaluator evaluateThis(pair);

		REQUIRE(evaluateThis.evaluate() == "Pair");
	}
}